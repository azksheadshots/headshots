...
const blogPosts = [
    {
      ...
      content: `
        ...
        <p>Your attire speaks volumes. Choose an outfit that reflects your industry and the role you're aiming for. For corporate roles, think classic and professional. For creative fields, you can show more personality. Avoid busy patterns or logos that can distract from your face. When in doubt, solid colors are a safe and effective choice.</p>
    ...
    },
    {
      ...
      content: `<p>Content for "What to Wear: Corporate Edition" goes here.</p>`
    },
    {
      ...
      content: `<p>Content for "The Power of a Professional Image" goes here.</p>`
    },
];
